...
namespace Pegasus
{
    ...
    public class PegasusPoiEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            {
                Vector3 lookAtLocation = m_poi.m_manager.GetValidatedLookatPosition(
            ...
            if (Event.current.control == true && Event.current.type == EventType.KeyDown)
            {
                ...
                if (Event.current.keyCode == m_poi.m_manager.m_defaults.m_keyLeft)
                {
                    ...
                    Vector3 movement = Quaternion.Euler(0F, SceneView.lastActiveSceneView.rotation.eulerAngles.y, 0f) *
                                       Vector3.left;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(20);
            PegasusConstants.LookatType lookatType =
            ...
            GUILayout.Space(20);
            PegasusConstants.SpeedType speedType =
            ...
            GUILayout.Space(20);
            PegasusConstants.PoiHeightCheckType heightCheckType =
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                if (!PegasusPoi.ApproximatelyEqual(m_poi.m_lookAtAngle, lookAtAngle))
                {
                    ...
                    m_poi.m_lookatLocation = m_poi.transform.position +
                                             (m_poi.transform.localRotation *
