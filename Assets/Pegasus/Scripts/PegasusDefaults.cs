...
namespace Pegasus
{
    ...
    {
        [Header("POI Selection Ctrl")] public KeyCode m_keyPrevPoi = KeyCode.Home;
        ...
        [Header("Gizmo Sizes")] [Range(1f, 6f)]
        public float m_poiGizmoSize = 5f;

        [Range(1f, 6f)] public float m_lookatGizmoSize = 2f;

        [Header("AutoBank Settings")] public bool m_autoBankOnByDefault = false;

        [Range(0f, 90f)] public float m_maxAutoBankAngle = 45f;

        [Range(0f, 90f)] public float m_maxAutoBankSpeed = PegasusConstants.SpeedFast;
