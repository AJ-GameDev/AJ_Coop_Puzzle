...
namespace Pegasus
{
    ...
    public class PegasusCapture : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (m_path == null) m_path = PegasusPath.CreatePegasusPath();

            //Show reticule
            if (m_reticuleGO == null) m_reticuleGO = GameObject.Find("Pegasus Capture Reticule");
            ...
            {
                //Clear path
                if (m_clearOnStart) m_path.ClearPath();
        ...
        private void Update()
        {
            if (Application.isPlaying)
            {
                ...
                if (!m_enableOnStart) return;

                //Exit if we are doing nothing
                if (m_path == null || m_mainCamera == null) return;
        ...
        {
            if (m_reticuleGO == null) m_reticuleGO = GameObject.Find("Pegasus Capture Reticule");
            if (m_reticuleGO != null) m_reticuleGO.SetActive(m_showReticule && m_enableOnStart);
        }
        ...
        public void UpdateReticuleText()
        {
            ...
            if (m_reticuleGO != null)
            {
                var texts = m_reticuleGO.GetComponentsInChildren<Text>();
