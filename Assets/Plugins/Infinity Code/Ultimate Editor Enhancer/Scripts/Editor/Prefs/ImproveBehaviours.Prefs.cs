        ...
        private class ImproveBehavioursManager : PrefManager, IHasShortcutPref
        {
            ...
            public IEnumerable<Shortcut> GetShortcuts()
            {
                ...
                if (changeNumberFieldValueByArrow)
                {
                    ...
                    shortcuts.Add(new Shortcut("Decrease Value By 1", "Number Field", EventModifiers.None,
                        KeyCode.DownArrow));
            ...
            public override void Draw()
            {
                ...
                improveAddComponentBehaviour =
                    EditorGUILayout.ToggleLeft("Add Component By Shortcut", improveAddComponentBehaviour);
                improveDragAndDropBehaviour =
                    EditorGUILayout.ToggleLeft("Drag And Drop To Canvas", improveDragAndDropBehaviour);
                _improveCurveEditor = EditorGUILayout.ToggleLeft("Improve Curve Editor", _improveCurveEditor);
                improveMaximizeGameViewBehaviour =
                    EditorGUILayout.ToggleLeft("Maximize Game View By Shortcut (SHIFT + Space)",
                        improveMaximizeGameViewBehaviour);
